...
CREATE TABLE IF NOT EXISTS `addresses` (
  ...
  `street` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `address_type` enum('Home','Work','Other') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `status` enum('Placed','Packed','Shipped','Delivered','Cancelled','Returned') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `payment_mode` enum('UPI','Card','NetBanking','COD') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payment_status` enum('Pending','Completed','Failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(5, 6, 45000.00, 'COD', 'Pending', '2026-06-05 10:45:05'),
(6, 7, 90000.00, 'COD', 'Pending', '2026-06-05 11:01:05'),
(7, 8, 45000.00, 'COD', 'Pending', '2026-06-05 11:15:45'),
(8, 9, 45000.00, 'COD', 'Pending', '2026-06-05 11:20:35');
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `price` double(10,2) DEFAULT NULL,
  `product_condition` enum('New','Like New','Good','Fair','Poor') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, 'iPhone 11', 'iphone11.png', 'Good condition used phone', 25000.00, 'Good', 5, 'Active', 1, 'Approved', NULL, '2026-02-26 14:39:22', NULL),
...
(4, 'Test Laptop', 'laptop.png', 'i5 8GB RAM', 45000.00, NULL, 1, 'Active', 3, 'Approved', NULL, '2026-03-07 13:33:03', NULL),
...
(15, 'soap', 'soap.png', 'soap!', 200.00, 'Good', 3, NULL, 6, 'Approved', NULL, '2026-05-07 17:00:36', NULL),
...
CREATE TABLE IF NOT EXISTS `refunds` (
  ...
  `amount` double(10,2) DEFAULT NULL,
  `status` enum('Pending','Processed','Failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `return_requests` (
  ...
  `status` enum('Requested','Approved','Rejected','Completed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `role_master` (
  `roleid` int NOT NULL,
  `rolename` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`roleid`),
